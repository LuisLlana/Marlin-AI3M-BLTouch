 ...
 */
   ...
   */
  #define CUSTOM_BUILD_VERSION "v1.4.6-6"

  /**
   * Verbose version identifier which should contain a reference to the location
   * from where the binary was downloaded or the source code was compiled.
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " (Github, davidramiro, Luis Llana)"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2020-11-22"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/LuisLlana/Marlin-AI3M-BLTouch.git"
